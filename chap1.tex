...
%EM I'd suggest "B and T cells" here and below, but "B- and T-cells" is an alternative. I've never seen " -and".
...
%EM I'm going to stop adding backslashes, but it's the right thing to do in latex.
...
%EM Do we just take FDCs with the same antigen for granted? Also, "immunizing" is only in the case of a vaccine.
...
%EM Might want to describe division here too.
...
%EM Independence is a statistical term, and parsimony isn't a statistical concept. I'd just state the formula.
...
%EM If you are going to describe branch and bound for trees, use a citation.
The branch and bound algorithm is a way of decreasing search space but still finding the best solution, however even with this hill climbing methods have to be used.
...
%EM This is a sentence fragment below.
...
%EM Actually, the Felsenstein paper shows that MP can do the wrong thing even with the simplest sequence evolution process!
