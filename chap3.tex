...
While it is clear that joint reconstruction is the more probabilistic correct way of inferring ancestral sequences there is less clarity about whether or not this changes the estimated sequences.
...
%The ordered list of sequences constitute the reconstructed ancestral lineage for the leafs picked and it always start with the root sequence and ends with the leaf.
...
% Doing the same calculations on all leafs on the tree and summing this will give the total alignment score of the inferred phylogeny.
\begin{table}[ht!]
\centering
\begin{tabular}{|lcccc|}
\hline
