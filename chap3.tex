...
The ancestral lineage is the objective so let's use this to define COAR, and let's also set COAR to be the expected per-site error in such a reconstruction.
