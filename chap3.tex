...
%EM WRT simulation of SHM, many Kleinstein papers have done it. There are also many tools such as Clone that have simulated GCs (though not with a targeting model AFAIK).
