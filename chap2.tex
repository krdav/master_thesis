...
%
Agent based GC simulation \cite{robert2017simulate}.
Cells are agents in a 3 dimensional grid of cells.



The model defined in this work is sparse and do not suffer from the same extend of over-parameterization as agent based models.



% From previous section, on other simulation tools
