...
A very similar model was suggested by Reshetova et al. \cite{Reshetova_2017}, but unlike Clone, authors claimed that software can be access on request with a permissive open source license.
...
Non of the other above mentioned simulation methods are explicitly simulating the DNA sequences and therefore cannot be used without substantial adaptations.
