...
%EM I'm not sure what this next sentence means. Is it necessary?
...
%EM This is a different version of Kd_def but it seems confusing to re-introduce it in this way.
...
\end{equation}
%EM I suggest moving the rest of this paragraph to the end, and describing it as an implementation detail. I can see that it's helpful, but it's a little disruptive to change notation halfway through.
...
%EM In this application we use will use Hamming distance on amino acids?
...
%EM 1. I found dm as a variable name to be very confusing, given that d is already a variable name. If you don't like m you could use d_t for d and d_m for dm.
%EM 2. I think this ratio form is clearer.
\begin{equation}
...
\begin{equation}
%EM What is T? Note that it's used above for the stopping time.
